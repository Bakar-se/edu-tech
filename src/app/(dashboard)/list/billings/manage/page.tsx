...
const Schema = z.object({
    ...
    amount: z
        .preprocess((val) => Number(val), z.number().min(1, "Amount must be positive")),
...
const ManageBilling = () => {
    ...
    const billingMutation = useMutation({
        ...
        onSuccess: () => {
            toast.success(`Billing ${action === "create" ? "created" : "updated"} successfully!`);
            form.reset();
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <Input type="text" placeholder="e.g. Tuition Fee" {...field} />
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
