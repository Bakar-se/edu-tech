...
const createGroupFormSchema = z.object({
  ...
  members: z
    .string()
    .array()
    .min(1, { message: "You must select at least one person" }),
});
        ...
        <Form {...form}>
          ...
          >
                              ...
                              >
                                <Avatar className="w-8 h-8">
                                  ...
                                  <AvatarFallback className="flex items-center justify-center w-full">
                                    {friends.username.substring(0, 1)}
                                  </AvatarFallback>
                                </Avatar>
            ...
            {members && members.length ? (
              <Card className="flex items-start justify-center gap-3 oveflow-x-auto w-full h-24 p-2 no-scrollbar">
                {friends
                    ...
                    return (
                      ...
                      >
                        <div className="relative">
                          ...
                          <X
                            className="text-destructive w-4 h-4 absolute bottom-8 left-7 bg-muted rounded-full cursor-pointer"
                            onClick={() =>
                              form.setValue(
                                "members",
