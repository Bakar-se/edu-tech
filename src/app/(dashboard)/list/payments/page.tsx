    ...
    return (
        <div className="container mx-auto px-4 py-10">
            ...
            {isLoading ? (
                ...
                <div className="text-red-500">Error loading payment records. Please try again later.</div>
            ) : (
                <DataTable
                    columns={columns}
                    data={payments}
                    filterableColumns={["studentId", "billingId", "method", "paymentDate"]} // Customize as needed
                />
            )}
        </div>
    );
